...
URL: `https://psicologo.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `psicologo.demo.federicocalo.dev`
...
- Output directory: `dist/psicologo/browser`
...
URL: `https://fedcal.github.io/federico-demo-psicologo/`
...
- `base: /federico-demo-psicologo/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `psicologo-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   psicologo-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `psicologo-docs.federicocalo.dev`
